...
const Product = () => {
	...
	return (
		<ThemeProvider defaultTheme='system' storageKey='vite-ui-theme'>
			<Header />
			<div className='default:h-screen flex flex-col p-10 justify-between border border-red-400 mobile:p-2 h-full'>
				<div className='ml-10'>
				...
				<div className='flex flex-col h-full w-full'>
					<div className='m-10 flex items-start mobile:flex-col gap-8 mt-10 w-full h-full'>
						<div className='w-full h-full max-h-[15rem]'>
							<ProductImage img_url={product.product?.image_url ?? ''} />
						</div>
						<div className='flex flex-col gap-5 justify-between h-full pb-10 mr-[30%]'>
