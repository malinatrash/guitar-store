...
const ProductCard: FC<Props> = ({ product }) => {
	...
	return (
		<div
			onClick={showProduct}
			className='transition-all duration-200 ease-linear hover:animate-pulse border-[2px] bg-white p-2 h-[28rem] min-w-[14rem] w-[23%] flex flex-col shadow-lg hover:shadow-2xl rounded-xl justify-between mobile:h-[32rem] mobile:w-[97%]'
		>
			<img
